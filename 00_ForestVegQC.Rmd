...
QCStems<-read.csv(paste0(DataDir,"/Stems.csv"), stringsAsFactors = F) %>% filter(Sample_Year %in% QCYears, !Latin_Name %in% Bad_Species)
...
- Beed a way to check that we don't exort data for plants that have been removed from study
