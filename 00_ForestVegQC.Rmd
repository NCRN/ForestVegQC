...
QCWoodies<-bind_rows( QCTrees %>% select(Plot_Name, Tag, Latin_Name, Cycle, Sample_Year, Status),   # used for condtions, foliage, vines
                      QCSaplings %>% select(Plot_Name, Tag, Latin_Name, Cycle, Sample_Year, Status),
                      QCShrubs %>% select(Plot_Name, Tag, Latin_Name, Cycle, Sample_Year, Status))
