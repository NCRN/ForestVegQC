...
Plots_Bad_Event_Latest<-QCPlots %>% 
   filter(!year(Event_Latest) %in% 2007:2023 | !month (Event_Latest) %in% 4:10) %>% 
...
if(nrow(Plots_Bad_Event_Latest)==0) cat("All plots have a latest event between April and October and between 2007 to 2023.<br>") else {
   errorText("Plots without a latest event between April and October and between 2007 to 2023:"); NiceTable(Plots_Bad_Event_Latest)}
```
