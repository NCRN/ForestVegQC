...
Plot_Rock_Change<-if(length(Repeat_Plot_Floor>0)){
  ...
  pivot_wider(id_cols=c(Plot_Name, Start_Year), names_prefix = "Cycle ", values_from = Rock_Cover, names_from = Cycle, names_sort = T)} else data.frame()
...
Plot_Bare_Soil_Change<-if(length(Repeat_Plot_Floor>0)){
  ...
  pivot_wider(id_cols=c(Plot_Name, Start_Year), names_prefix = "Cycle ", values_from = Bare_Soil_Cover, names_from = Cycle, names_sort = T)} else data.frame()
...
Plot_Trampled_Change<-if(length(Repeat_Plot_Floor>0)){
  ...
  pivot_wider(id_cols=c(Plot_Name, Start_Year), names_prefix = "Cycle ", values_from = Trampled, names_from = Cycle, names_sort = T)} else data.frame()
...
Plot_Deer_Change<-if(length(Repeat_Plot_Floor_Post_2013>0)){
  ...
  pivot_wider(id_cols=c(Plot_Name, Start_Year), names_prefix = "Cycle ", values_from = Deer_Impact, names_from = Cycle, names_sort = T) %>% 
