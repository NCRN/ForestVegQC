...
if(nrow(Species_No_Herbaceous)==0) cat("All species are classified as sensetitive or not.<br>") else {
errorText("Species records not classified as senstiive or not:"); NiceTable(Species_No_Senstive)}
