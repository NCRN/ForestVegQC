...
if(nrow(Plots_Mismatch_Unit_Group)==0) cat("All plots have Unit Group that is consistent with their Unit Code.<br>") else {
   cat("<span style='color:red;'> Plots with a Unit Group that is inconsistent with their Unit Code.</span><br>");NiceTable(Plots_Mismatch_Unit_Group)}
...
cat("<br>**Counties nd Parks**<br>")
if(nrow(Plots_Inconsistent_County)==0) cat("All plots' coutnies are consistnet with their park.<br>") else {
