...
- CWD: Need to export tree tag to make sure it is correponds to a local tree/ sapling

## Plots


```{r child="ForestVegPlotsQC.Rmd"}
```


## Events

```{r child="ForestVegEventsQC.Rmd"}
```
 
## Plot Floor

```{r child="ForestVegPlotFloorQC.Rmd"}
```

## CWD 

```{r child="ForestVegCWDQC.Rmd"}
```
