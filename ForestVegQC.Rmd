...
DataDir<-"C:/Data/Veg_NCRN"
#DataDir<-"C:/Data/Veg2020/"
#DataDir<-"C:/Users/jschmit/Desktop/Some data/ExtraPlaces2020/NCRN_2020_ForestVeg"


NCRN<-importNCRN(DataDir)
#NCRN<-importCSV(DataDir)
...
- Deer Impact value not exported. Need to check that it exists and is an allowable value

_ Need to check if Deer impact is changing 2 or more between visits.


#### CWD
- Need a mechanism to check if Latin names are reasonable

- Need to export tree tags to make sure they correspond to a local tree/ sapling
