...
- Trees: Need  a mechanism ot check if Latin names are reasonable

- Trees: Need a way to check that tree tag is not retired

- Trees: Need to export the foliage conditions, tree conditions and vines checkboxes. Need to check living trees are checked, and non-EAB dead trees are not.
